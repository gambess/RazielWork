...
class DefaultController extends Controller
{
    ...
    {
        $contadores = array();
        $cleaner = new CleanManager();
        $em = $this->getDoctrine()->getManager();
        
        //TODO: Quitar las peticiones de data access de aqui
        $entities = $em->getRepository('FractaliaSmsBundle:Sms')->getSmsAndMessageJoined();
        ...
        $nombres = $em->getRepository('FractaliaSmsBundle:Nombrecorto')->findBy(array(), array('nombre' => 'ASC'));
//        $nombres = $em->getRepository('FractaliaSmsBundle:Nombrecorto')->findAll();
        ...
        $contadores = $this->getCounterFromArray($entities);
...
//            $nombres = $em->getRepository('FractaliaSmsBundle:Nombrecorto')->findAll();
    ...
    protected function getCounterFromArray(array $array)
    {
        $error = 0;
        $build = 0;
        $send = 0;
        ...
        $contadores["total"] = count($array);
        $contadores["error"] = $error;
        $contadores["enviado"] = $send;
        $contadores["enviar"] = $tosend;
        $contadores["build"] = $build;
        $contadores["asent"] = $asent;
