 ...
 * Mensaje
 *
 * @ORM\Table(name="Mensaje", indexes={@ORM\Index(name="fk_Mensaje_ColumnaEvento1_idx", columns={"columna_evento_id"}), @ORM\Index(name="nombre_plantilla", columns={"nombre_plantilla"}), @ORM\Index(name="estado", columns={"estado"}), @ORM\Index(name="fecha_creacion", columns={"fecha_creacion"})})
 * @ORM\Entity
