...
use Pi2\Fractalia\SmsBundle\Manager\CopiaIncidenciaEnEventoManager;
...
class MensajeManager
{
     ...
     * 
     * @param mixed Incidencia|Array|string $data Incidencia Capturada o Array con resumenes o string con mensaje
     * @param string $plantilla
     * @param type $em
     * @return int id id del Mensaje
     */
    public function createMensaje($data, $plantilla = null, $em = null)
    {
        ...
        if ($data instanceof Incidencia and $plantilla != null)
        {
            ...
            $array = new CopiaIncidenciaEnEventoManager($plantilla, $this->configuraciones->getTsolGuardia(), $this->configuraciones->getNombresCortos(), $this->configuraciones->getTraduccionesTipos(), $this->configuraciones->getTraduccionesMatriculas());
    ...
    /**
     * Se renderiza la plantilla con el texto en txt. Se renderiza la plantilla con el texto en txt
     * 
     * @param Incidencia $entity
     * @param string $plantilla
     * @return string
     */
