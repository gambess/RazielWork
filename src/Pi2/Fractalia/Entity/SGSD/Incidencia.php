 ...
 * Incidencia
 *
 * @ORM\Table(name="Incidencia", indexes={@ORM\Index(name="NumeroCaso", columns={"NumeroCaso"}), @ORM\Index(name="FechaActualizacion", columns={"FechaActualizacion"}), @ORM\Index(name="GrupoOrigen", columns={"GrupoOrigen"}), @ORM\Index(name="GrupoDestino", columns={"GrupoDestino"}), @ORM\Index(name="TecnicoAsignadoInicial", columns={"TecnicoAsignadoInicial"}), @ORM\Index(name="TecnicoAsignadoFinal", columns={"TecnicoAsignadoFinal"}), @ORM\Index(name="FechaInsercion", columns={"FechaInsercion"}), @ORM\Index(name="Estado", columns={"Estado"}), @ORM\Index(name="Prioridad", columns={"Prioridad"})})
 * @ORM\Entity
